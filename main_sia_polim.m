...
tic
global N M hS hB H iTimeStep enth_lst u_s_lst
...
data_init = load('test_arolla_poly');
AGlen_s = data_init.AGlen_s; % [Pa-3 a-1]
visc_s = data_init.visc_s; % [Pa a]
visc = data_init.visc; % [Pa a]
Eini = data_init.E;
...
for iTimeStep = 1:numTimeStep
    ...
    [u_s, u, visc_s, visc, strainHeat] = solver_u_iter_smedt_test(visc_s, visc, AGlen_s, p);
